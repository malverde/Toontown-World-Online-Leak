...
class PetshopGUI(DirectObject):
        ...
        def __init__(self, doneEvent):
            DirectFrame.__init__(
                self, pos=(
                    ...
                    1.0, 1.0, 0.6), text='', text_wordwrap=13.5, text_scale=0.06, text_pos=(
                    0.0, 0.13))
    ...
    class NamePicker(DirectFrame):
        ...
        def __init__(self, doneEvent, petSeed, gender):
            ...
            self.guiScale = 0.09
            DirectFrame.__init__(
                self, relief=None, geom=self.gui, geom_scale=self.guiScale,
                state='normal', frameSize=(-1, 1, -1, 1))
            ...
            self.alphabetList = self.makeScrollList(
                self.gui, (-0.012, 0, -0.075),
                (1, 0.8, 0.8, 1),
                self.letters, self.makeLabel, [TextNode.ACenter, 'alphabet'],
                6)
            self.nameList = None
            ...
            self.randomButton = DirectButton(
                ...
                scale=self.guiScale, text=TTLocalizer.RandomButton,
                text_pos=(-0.8, -5.7),
                text_scale=0.8, text_fg=text2Color, pressEffect=False,
                command=self.randomName)
            self.nameResult = DirectLabel(
                parent=self, relief=None, scale=self.guiScale, text='',
                text_align=TextNode.ACenter, text_pos=(-1.85, 2.6),
                text_fg=text0Color, text_scale=0.6, text_wordwrap=8)
            self.submitButton = DirectButton(
                ...
                scale=self.guiScale, text=TTLocalizer.PetshopAdopt,
                text_pos=(3.3, -5.7),
                text_scale=TTLocalizer.PGUIsubmitButton, text_fg=text0Color,
                pressEffect=False, command=lambda: messenger.send(
            ...
            self.cancelButton = DirectButton(
                parent=self, relief=None, pos=(-0.04, 0, -0.47),
        ...
        def rebuildNameList(self):
            ...
            self.nameList = self.makeScrollList(
                self.gui, (0.277, 0, -0.075),
                (1, 0.8, 0.8, 1),
                self.curNames, self.makeLabel, [TextNode.ACenter, 'name'],
                5)
    ...
    class MainMenuDlg(DirectFrame):
        ...
        def __init__(self, doneEvent):
            ...
            self.returnPetButton = DirectButton(
                parent=self, relief=None, image=returnImageList,
    ...
    class AdoptPetDlg(DirectFrame):
        ...
        def __init__(self, doneEvent, petSeed, petNameIndex):
            ...
            modelScale = 0.055
            DirectFrame.__init__(
                self, relief=None, state='normal', geom=model,
                geom_color=ToontownGlobals.GlobalDialogColor,
                geom_scale=modelScale, frameSize=(-1, 1, -1, 1),
                pos=modelPos, text=TTLocalizer.PetshopAdoptConfirm %
                (name, cost),
                text_wordwrap=12, text_scale=0.05, text_pos=(0, 0.55),
                text_fg=text0Color)
            ...
            self.moneyDisplay = DirectLabel(
                parent=self, relief=None, text=str(
                    base.localAvatar.getTotalMoney()), text_scale=0.075, text_fg=(
                    0.95, 0.95, 0, 1), text_shadow=(
                    0, 0, 0, 1), text_pos=(
                    0.225, 0.33), text_font=ToontownGlobals.getSignFont())
            self.accept(
            ...
            self.cancelButton = DirectButton(
                parent=self, relief=None, image=cancelImageList,
            ...
            self.okButton = DirectButton(
                parent=self, relief=None, image=okImageList, geom=checkIcon,
        ...
        def __init__(self, doneEvent):
            ...
            def showDialog(avatar):
                ...
                DirectFrame.__init__(
                    self, relief=None, state='normal', geom=model,
                    geom_scale=modelScale, frameSize=(-1, 1, -1, 1),
                    pos=modelPos, text=TTLocalizer.PetshopReturnConfirm %
                    avatar.getName(),
                    text_wordwrap=12, text_scale=TTLocalizer.PGUIreturnConfirm,
                    text_pos=(0, 0.45),
                    text_fg=text2Color)
                ...
                self.cancelButton = DirectButton(
                    ...
                    command=lambda: messenger.send(doneEvent, [0]))
                self.okButton = DirectButton(
                    parent=self, relief=None, image=okImageList,
                    geom=checkIcon, scale=modelScale,
    ...
    class ChoosePetDlg(DirectFrame):
        ...
        def __init__(self, doneEvent, petSeeds):
            ...
            DirectFrame.__init__(
                self, relief=None, state='normal', geom=model,
                geom_scale=modelScale, frameSize=(-1, 1, -1, 1),
                pos=modelPos, text=TTLocalizer.PetshopChooserTitle,
            ...
            self.pawLButton = DirectButton(
                parent=self, relief=None, image=pawLImageList,
            ...
            self.pawRButton = DirectButton(
                parent=self, relief=None, image=pawRImageList,
            ...
            self.okButton = DirectButton(
                ...
                pressEffect=False, command=lambda: messenger.send(
                    doneEvent, [self.curPet]))
            self.moneyDisplay = DirectLabel(
                parent=self, relief=None, text=str(
                    base.localAvatar.getTotalMoney()), text_scale=0.1, text_fg=(
                    0.95, 0.95, 0, 1), text_shadow=(
                    0, 0, 0, 1), text_pos=(
                    0.34, 0.12), text_font=ToontownGlobals.getSignFont())
            self.accept(
                localAvatar.uniqueName('moneyChange'),
                self.__moneyChange)
            self.accept(
        ...
        def showPet(self):
            self.nameLabel = DirectLabel(
                parent=self, pos=(
                    0, 0, 1.35), relief=None, text=self.petName[
                    self.curPet], text_fg=Vec4(
                    0.45, 0, 0.61, 1), text_pos=(
                    0, 0), text_scale=0.08, text_shadow=(
                        1, 1, 1, 1))
            self.petModel = Pet.Pet(forGui=1)
            ...
            self.descLabel = DirectLabel(
                parent=self, pos=(-0.4, 0, 0.72),
                relief=None, scale=0.05, text=self.petDesc[self.curPet],
    ...
    def doDialog(self, nDialog):
        ...
        if nDialog == Dialog_MainMenu:
            ...
            self.dialog = self.AdoptPetDlg(
                self.adoptPetDoneEvent, self.petSeeds[
    ...
    def __handleReturnPetDlg(self, exitVal):
        if exitVal == 0:
            ...
            if self.dialogStack[
                    len(self.dialogStack) - 2] == Dialog_NamePicker:
                self.doDialog(Dialog_AdoptPet)
            else:
                self.destroyDialog()
