...
class RaceResultsPanel(DirectFrame):
    ...
    def __init__(self, numRacers, race, raceEndPanel, *args, **kwargs):
        ...
        self.pointsLabel = DirectLabel(
            parent=self, relief=None, pos=(0.7, 0, 0.3),
        ...
        for x in range(self.numRacers):
            ...
            pLabel = DirectLabel(
                parent=frame, relief=None, pos=(0.0, 0.0, -0.01),
                text=repr((x + 1)) + ' -', text_fg=(0.5, 0.5, 0.5, 1.0),
            ...
            fFrame = DirectFrame(
                parent=frame, relief=None, pos=(
                    0.1, -0.01, 0.01))
            nLabel = DirectLabel(
                parent=frame, relief=None, pos=(0.46, 0.0, 0.0),
                text='', text_fg=(0.0, 0.0, 0.0, 1.0),
                text_scale=TTLocalizer.REPsmallLabel,
                text_align=TextNode.ACenter, text_font=DGG.getDefaultFont())
            tLabel = DirectLabel(
                parent=frame, relief=None, pos=(0.9, 0.0, 0.0),
                text="--'--''--", text_fg=(0.5, 0.5, 0.5, 1.0),
                text_scale=TTLocalizer.REPsmallLabel,
                text_font=DGG.getDefaultFont())
            wLabel = DirectLabel(parent=frame, relief=None,
                                 pos=(1.14, 0.0, 0.0),
                                 text='', text_fg=(0, 0, 0, 1),
                                 text_scale=TTLocalizer.REPsmallLabel,
    ...
    def displayRacer(
        ...
        if trophies:
            DirectFrame(
                parent=headFrame, relief=None, image=loader.loadModel(
                    'phase_6/models/karting/trophy'),
        ...
        if not circuitPoints == []:
            ...
            def newPointTicker(
                t, label=self.entryList[
                    place - 1][6], new=newPoints):
        ...
        for oldPlace, newPlace in placeFixup:
            if oldPlace != newPlace:
                ...
                def fixPlaceValue(oldPlace=oldPlace, newPlace=newPlace):
                    self.entryList[oldPlace][0][
                        'text'] = '%s -' % str(newPlace + 1)
...
class RaceWinningsPanel(DirectFrame):
    ...
    def __init__(self, race, *args, **kwargs):
        ...
        tLabel = DirectLabel(
            parent=tFrame, relief=None, pos=(
                0.0, 0.0, 0.25), text=TTLocalizer.KartRace_Tickets, text_fg=(
                0.0, 0.0, 0.0, 1.0), text_scale=0.1, text_font=DGG.getDefaultFont())
        DirectLabel(
            parent=tFrame,
            relief=None,
            pos=(
        ...
        DirectLabel(
            ...
            text_font=DGG.getDefaultFont())
        bLabel = DirectLabel(
            parent=tFrame, relief=None, pos=(0.05, 0.0, -0.1),
            text=TTLocalizer.KartRace_Zero, text_fg=(0.0, 0.0, 0.0, 1.0),
            text_scale=TTLocalizer.REPlargeLabel, text_align=TextNode.ARight,
            text_font=DGG.getDefaultFont())
        ...
        self.doubleTicketsLabel = DirectLabel(
            parent=tFrame, relief=None, pos=(0.5, 0.0, -0.26),
            ...
            text_font=DGG.getDefaultFont())
        fLabel = DirectLabel(
            parent=tFrame, relief=None, pos=(0.05, 0.0, -0.2),
            text=TTLocalizer.KartRace_Zero, text_fg=(0.0, 0.0, 0.0, 1.0),
            text_scale=TTLocalizer.REPlargeLabel, text_align=TextNode.ARight,
            text_font=DGG.getDefaultFont())
        ticketPic = DirectFrame(parent=tFrame, relief=None, image=loader.loadModel(
            'phase_6/models/karting/tickets'), image_pos=(0.5, 0, -0.02), image_scale=0.4)
        ...
        tLabel = DirectLabel(
            parent=tFrame, relief=None, pos=(
                0.0, 0.0, 0.25), text=TTLocalizer.KartRace_Bonus, text_fg=(
                0.0, 0.0, 0.0, 1.0), text_scale=0.1, text_font=DGG.getDefaultFont())
        ...
        tLabel = DirectLabel(
            parent=tFrame, relief=None, pos=(
                0.0, 0.0, 0.25), text=TTLocalizer.KartRace_Trophies, text_fg=(
                0.0, 0.0, 0.0, 1.0), text_scale=0.1, text_font=DGG.getDefaultFont())
        textFrame = DirectFrame(parent=tFrame,
                                relief=None,
                                text='',
    ...
    def generateDisplaySequences(
                ...
                Sequence(
                    ...
                    Func(
                        ...
                        text=wrapStr(
                            ...
                            (TTLocalizer.KartRecordStrings
                             [bonusType],
                             TTLocalizer.KartRace_TrackNames
                             [track],
                             str(ticBonus)))),
                    Wait(3)))
        ticketSeq.append(
                        ...
                        self.ticketComponents[3].configure, text_color=Vec4(
                            0, 0, 0, 1)), Func(
                                self.ticketComponents[0].configure, text_color=Vec4(
                                    1, 0, 0, 1)), Parallel(
                                        LerpFunc(
                                            ticketTicker, duration=(
                                                ticDeposit and [1] or [0])[0], extraArgs=[
                                                                                                                    ...
                                                                                                                    0, 0, 0, 1)), Func(
                                                                                                                        self.ticketComponents[2].configure, text_color=Vec4(
                                                                                                                            1, 0, 0, 1)), Parallel(
                                                                                                                                LerpFunc(
                                                                                                                                    ticketTicker, duration=(
                                                                                                                                        origTicBonus and [1] or [0])[0], extraArgs=[
        ...
        def showCorrectTrophy(trophyId):
            ...
            self.trophyImage = RacingTrophy(
                level=trophyId, parent=self.trophyComponents[1],
                pos=(0.5, 0, -0.25))
...
class RaceEndPanel(DirectFrame):
    ...
    def __init__(self, numRacers, race, *args, **kwargs):
        ...
        self.winnings = RaceWinningsPanel(
            race, parent=self, pos=(0, 0, -0.525))
        ...
        self.closeButton = DirectButton(
            ...
            relief=None, scale=2.0, text=exitText,
            text_scale=TTLocalizer.REPsmallLabel, text_pos=(0, -0.1),
