...
class CalendarGuiDay(DirectFrame):
    ...
    def addOncelyHolidayToScrollList(self, holiday):
        ...
        startDate = datetime.date(
            holidayStart[0], holidayStart[1], holidayStart[2])
        endDate = datetime.date(
            holidayStart[0], holidayEnd[1], holidayEnd[2])
        ...
        if holidayId in TTLocalizer.HolidayNamesInCalendar:
            ...
            holidayDesc = ''
        if holidayStart[1] == holidayEnd[
            1] and holidayStart[2] == holidayEnd[2]:
        ...
        elif self.myDate.year == holidayEnd[0] and self.myDate.month == holidayEnd[1] and self.myDate.day == \
                holidayEnd[2]:
...
class MiniInviteVisual(DirectFrame):
    def __init__(self, parent, partyInfo):
        ...
        self.whosePartyLabel = DirectLabel(parent=self, relief=None, pos=(0.07, 0.0, -0.04), text=' ', text_scale=0.04,
                                           text_wordwrap=8, textMayChange=True)
        self.whenTextLabel = DirectLabel(parent=self, relief=None, text=' ', pos=(0.07, 0.0, -0.13), text_scale=0.04,
                                         textMayChange=True)
