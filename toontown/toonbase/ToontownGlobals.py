...
MintCogBuckRewards = {CashbotMintIntA: 8,
                      CashbotMintIntB: 14,
                      CashbotMintIntC: 20}
MintNumRooms = {CashbotMintIntA: 2 *
                (6,) +
                5 *
                (7,) +
                5 *
...
StageNoticeRewards = {LawbotStageIntA: 75,
                      ...
                      LawbotStageIntC: 225,
                      LawbotStageIntD: 300}
StageNumRooms = {LawbotStageIntA: 2 *
                 (6,) +
                 5 *
                 (7,) +
                 5 *
                 ...
                 (10,) +
                 5 *
                 (11,), LawbotStageIntC: 4 *
                 (10,) +
                 10 *
                 (11,) +
                 6 *
                 (12,), LawbotStageIntD: 4 *
                 (10,) +
                 10 *
                 (11,) +
                 6 *
...
# This is 'Full' in the book, but friends can still TP onto shard (soft red)
MID_POP = 6
# Still 'Full' in book, but nobody joins this shard for any reason (hard red)
HIGH_POP = 10
...
# This was 20 - far too high - but we need to test and find a good value
# for this.
BossbotSpeedRecoverRate = 2
