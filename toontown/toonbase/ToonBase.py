...
class ToonBase(OTPBase.OTPBase):
    ...
    def __init__(self):
        ...
        if platform == "darwin":
            ...
            self.acceptOnce(
                ToontownGlobals.MinimizeGameHotKeyOSX,
                self.minimizeGame)
            self.accept(
                ToontownGlobals.MinimizeGameHotKeyRepeatOSX,
                self.minimizeGame)
    ...
    def initNametagGlobals(self):
        ...
        self.bottomCells = [
            ...
            # To the left of the shtiker book
