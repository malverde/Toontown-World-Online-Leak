    ...
    def __init__(self, av=None, position=0, paid=0, okToLockout=1):
        ...
        if self.mode is AvatarChoice.MODE_LOCKED:
            ...
            self.nameText = DirectLabel(
                parent=self, relief=None, scale=0.08,
                pos=NAME_POSITIONS[position],
                text=self.name, hpr=(0, 0, NAME_ROTATIONS[position]),
                text_fg=(1, 1, 1, 1),
                text_shadow=(0, 0, 0, 1),
                text_wordwrap=8, text_font=ToontownGlobals.getToonFont(),
                state=DGG.DISABLED)
            ...
            self.statusText = DirectLabel(
                parent=self, relief=None, scale=0.09, pos=(0, 0, -0.24),
                text='', text_fg=(1, 1, 1, 1),
                text_shadow=(0, 0, 0, 1),
                text_wordwrap=7.5, text_scale=TTLocalizer.ACstatusText,
    ...
    def verifyDeleteWithPassword(self):
        ...
        if self.deleteWithPasswordFrame is None:
            ...
            self.deleteWithPasswordFrame = DirectFrame(
                pos=(0.0, 0.1, 0.2),
                parent=aspect2dp, relief=None,
                image=DGG.getDefaultDialogGeom(),
                image_color=ToontownGlobals.GlobalDialogColor,
                image_scale=(1.4, 1.0, 1.0),
                text=deleteText, text_wordwrap=19,
            ...
            if self.deleteWithPassword:
                self.passwordLabel = DirectLabel(
                    parent=self.deleteWithPasswordFrame, relief=None,
                    pos=(-0.07, 0.0, -0.2),
                    text=TTLocalizer.AvatarChoicePassword, text_scale=0.08,
                ...
                DirectButton(parent=self.deleteWithPasswordFrame,
                             ...
                             textMayChange=0, pos=(-0.22, 0.0, -0.35),
                             command=self.__handleDeleteWithPasswordOK)
            else:
                self.passwordEntry = DirectEntry(
                    parent=self.deleteWithPasswordFrame, relief=None,
                    image=nameBalloon, image1_color=(0.8, 0.8, 0.8, 1.0),
                    scale=0.064, pos=(-0.3, 0.0, -0.2),
                    width=10, numLines=1, focus=1, cursorKeys=1,
            ...
            DirectButton(parent=self.deleteWithPasswordFrame,
                         image=cancelButtonImage, relief=None,
