    ...
    def enterCogLanding(self, offset):
       ...
       # self.buddyStandDie = Sequence(
        ...
        self.cogSequence = Sequence(
            ...
            Wait(1),
            Func(self.buddy.setChatAbsolute, "No, don't tell me. Let me guess. Errrr... Montana. Final answer. No, no, nevermind.... Hrmm...", CFSpeech|CFTimeout),
            Wait(1),
            ...
            Wait(6),
            Func(self.suit.setChatAbsolute, 'But... you seem to need a cheesy ending.', CFSpeech|CFTimeout, dialogue = self.speechStatementSfx),
