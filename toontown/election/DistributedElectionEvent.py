...
class DistributedElectionEvent(DistributedObject, FSM):
    ...
    def enterCogLanding(self, offset):
        ...
        self.cogSequence = Sequence(
            ...
            Wait(1),
            Func(self.flippy.setChatAbsolute, "Ooh, and the suit too looks nice on you. ", CFSpeech|CFTimeout),
            Wait(5),
    ...
    def enterInvasion(self, offset):
        ...
        self.surleeIntroInterval = Sequence(
            ...
            Wait(1),
            Func(self.Buddy.setChatAbsolute, "Flippy what should I do?", CFSpeech|CFTimeout),
            wait(5),
            Func(self.flippy.setChatAbsolute, 'Help me make some pies.', CFSpeech|CFTimeout),
            wait(5), 
            Func(self.Buddy.setChatAbsolute, "Ok", CFSpeech|CFTimeout),
            Func(self.Buddy.loop, 'walk'),
            self.flippy.posHprInterval(1, (-4, 8.5, 3.03), (110, 0, 0)),
            Func(self.Buddy.play, 'jump'),
            Func(self.Buddy.loop, 'run'),
            self.Buddy.posHprInterval(3.5, (-38, -18.5, 0), (100, 0, 0)),
            Func(self.Buddy.loop, 'walk'),
