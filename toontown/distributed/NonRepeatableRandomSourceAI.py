...
class NonRepeatableRandomSourceAI(DistributedObjectAI):
    ...
    def _sampleRandom(self):
        self.air.sendUpdateToDoId(
            'NonRepeatableRandomSource', 'randomSample', OtpDoGlobals.
            OTP_DO_ID_TOONTOWN_NON_REPEATABLE_RANDOM_SOURCE,
    ...
    def getRandomSamples(self, callback, num=None):
        ...
        self.air.sendUpdateToDoId(
            'NonRepeatableRandomSource', 'getRandomSamples', OtpDoGlobals.
            OTP_DO_ID_TOONTOWN_NON_REPEATABLE_RANDOM_SOURCE,
