...
class SuitLegList:
    ...
    def createFirstLeg(self):
        ...
        if startPoint.type == DNASuitPoint.SIDEDOORPOINT:
    ...
    def createLeg(self, a, b):
        assert a != b
        if a.type in (DNASuitPoint.FRONTDOORPOINT,
                      DNASuitPoint.SIDEDOORPOINT):
            legType = SuitLeg.TWalkToStreet
        elif b.type in (DNASuitPoint.FRONTDOORPOINT,
                        DNASuitPoint.SIDEDOORPOINT):
        ...
        if a.type ==DNASuitPoint.COGHQOUTPOINT:
        ...
        elif b.type == DNASuitPoint.COGHQINPOINT:
    ...
    def createLastLeg(self):
        ...
        if endPoint.type == DNASuitPoint.FRONTDOORPOINT:
            legType = SuitLeg.TToToonBuilding
        elif endPoint.type == DNASuitPoint.SIDEDOORPOINT:
