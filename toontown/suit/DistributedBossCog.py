...
class DistributedBossCog(DistributedAvatar.DistributedAvatar, BossCog.BossCog):
                    ...
                    Func(
                        ...
                        dustCloud.track, Sequence(
                            Wait(0.3), Func(
                                ...
                                toon.sadEyes), Func(
                                toon.blinkEyes), Func(
                                    toon.play, 'slip-backward'), Wait(0.7))), Func(
    ...
    def enterIntroduction(self):
        ...
        delayDeletes = []
        seq = Parallel(self.showTitleText(), Sequence(self.makeIntroductionMovie(delayDeletes), Func(self.__beginBattleOne)),
        name=intervalName)
            ...
            suitsOff.append(
                Sequence(
                    Func(
                        ...
                        dustCloud.track, Sequence(
                            Wait(0.3), Func(
                                self.putToonInCogSuit, toon), makeWaiter, Wait(0.7))), Func(
    ...
    def showTitleText(self):
        ...
        titleText = OnscreenText.OnscreenText(TTLocalizer.BossLocations[self.style.dept], fg=(1, 1, 1, 1), shadow=(0, 0, 0, 1),
                                              font=ToontownGlobals.getSuitFont(), pos=(0, -0.5), scale=0.16, wordwrap=16)
