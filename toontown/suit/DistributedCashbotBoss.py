...
class DistributedCashbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def __makeGoonMovieForIntro(self):
        ...
        return Sequence(
            Func(
                self.__showFakeGoons, 'Walk'), goonTrack, Func(
                self.__hideFakeGoons))
    ...
    def __makeGoonMovieForBattleThree(self):
        goonPosHprs = [[Point3(111, -
                               287, 0), VBase3(165, 0, 0), Point3(101, -
                                                                  323, 0), VBase3(165, 0, 0)], [Point3(119, -
                                                                                                       315, 0), VBase3(357, 0, 0), Point3(121, -
                                                                                                                                          280, 0), VBase3(357, 0, 0)], [Point3(102, -
                                                                                                                                                                               320, 0), VBase3(231, 0, 0), Point3(127, -
                                                                                                                                                                                                                  337, 0), VBase3(231, 0, 0)]]
        ...
        goonTrack = Sequence(
            Func(
                self.__showFakeGoons, 'Walk'), Func(
    ...
    def makePrepareBattleThreeMovie(self, delayDeletes, crane, safe):
        ...
        track = Sequence(
            ...
            Func(
                rToon.setChatAbsolute, TTL.ResistanceToonWatchThis, CFSpeech),
            Wait(2),
            Func(rToon.clearChat),
            Func(base.camera.setPosHpr, 105, -326, 20, -45.3, 11, 0),
            Func(
                self.setChatAbsolute, TTL.CashbotBossGetAwayFromThat,
                CFSpeech),
            Wait(2),
            Func(self.clearChat),
            base.camera.posHprInterval(
                1.5, Point3(105, -326, 5),
                Point3(136.3, 0, 0),
                blendType='easeInOut'),
            Func(
                rToon.setChatAbsolute, TTL.ResistanceToonCraneInstructions1,
                CFSpeech),
            Wait(4),
            Func(
                rToon.setChatAbsolute, TTL.ResistanceToonCraneInstructions2,
                CFSpeech),
            Wait(4),
            Func(
                rToon.setChatAbsolute, TTL.ResistanceToonCraneInstructions3,
                CFSpeech),
            Wait(4),
            Func(
                rToon.setChatAbsolute, TTL.ResistanceToonCraneInstructions4,
                CFSpeech),
            Wait(4),
            Func(rToon.clearChat),
        ...
        return Sequence(Func(base.camera.reparentTo, self), Func(
            base.camera.setPosHpr, 0, -27, 25, 0, -18, 0), track)
    ...
    def makeBossFleeMovie(self):
        ...
        rollThroughDoor = self.rollBossToPoint(
            ...
            fromHpr=None, toPos=Point3(120, -250, 0),
    ...
    def grabObject(self, obj):
        ...
        obj.lerpInterval = Parallel(
            obj.posInterval(
                ToontownGlobals.CashbotBossToMagnetTime, Point3(
                    -1, 0, 0.2)),
            obj.quatInterval(
                ToontownGlobals.CashbotBossToMagnetTime, VBase3(
                    0, -90, 90)),
            Sequence(
        ...
        if self.prevCogSuitLevel < ToontownGlobals.MaxCogSuitLevel:
            ...
            if newCogSuitLevel == maxCogSuitLevel:
                if newCogSuitLevel != ToontownGlobals.MaxCogSuitLevel:
                    suitIndex = ((cogTypes[deptIndex] + 1)
                                 * (deptIndex + 1)) - 1
                    cogTypeStr = SuitDNA.suitHeadTypes[suitIndex]
                    cogName = SuitBattleGlobals.SuitAttributes[
                        cogTypeStr]['name']
    ...
    def enterPrepareBattleThree(self):
        ...
        seq = Sequence(
            self.makePrepareBattleThreeMovie(
                ...
                self.__beginBattleThree), name=intervalName)
