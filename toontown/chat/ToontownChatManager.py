...
class ToontownChatManager(ChatManager.ChatManager):
    ...
    def __init__(self, cr, localAvatar):
        ...
        self.normalButton = DirectButton(
            ...
            pos=(0.0683, 0, -0.072),
            parent=base.a2dTopLeft, scale=1.179, relief=None,
            image_color=Vec4(1, 1, 1, 1),
            text=('', OTPLocalizer.ChatManagerChat, OTPLocalizer.
                  ChatManagerChat),
        ...
        self.whisperFrame = DirectFrame(
            ...
            image_scale=(0.77, 0.70, 0.20),
            image_color=OTPGlobals.GlobalDialogColor, pos=(0.40, 0, -0.105),
            text=OTPLocalizer.ChatManagerWhisperTo, text_wordwrap=6.5,
            text_scale=TTLocalizer.TCMwhisperFrame, text_fg=Vec4(0, 0, 0, 1),
            text_pos=(0.18, 0.01),
        ...
        self.whisperButton = DirectButton(
            ...
            image=(gui.find('**/ChtBx_ChtBtn_UP'),
                   ...
                   gui.find('**/ChtBx_ChtBtn_RLVR')),
            pos=(-0.33, 0, 0.033),
            scale=1.179, relief=None, image_color=Vec4(1, 1, 1, 1),
            text=('', OTPLocalizer.ChatManagerChat, OTPLocalizer.
                  ChatManagerChat, ''),
        ...
        self.whisperScButton = DirectButton(
            ...
            image=(gui.find('**/ChtBx_ChtBtn_UP'),
                   ...
                   gui.find('**/ChtBx_ChtBtn_RLVR')),
            pos=(-0.195, 0, 0.033),
            scale=1.179, relief=None, image_color=Vec4(0.75, 1, 0.6, 1),
            text=('', OTPLocalizer.GlobalSpeedChatName, OTPLocalizer.
                  GlobalSpeedChatName, ''),
            image3_color=Vec4(0.6, 0.6, 0.6, 0.6),
        ...
        self.whisperCancelButton = DirectButton(
            ...
            text=('', OTPLocalizer.ChatManagerCancel, OTPLocalizer.
                  ChatManagerCancel),
    ...
    def enterOpenChatWarning(self):
        if self.openChatWarning is None:
            ...
            self.openChatWarning = DirectFrame(
                parent=aspect2dp, pos=(0.0, 0.1, 0.2),
                ...
                textMayChange=0)
            DirectButton(
                self.openChatWarning, image=buttonImage, relief=None,
                text=OTPLocalizer.OpenChatWarningOK, text_scale=0.05,
                text_pos=(0.0, -0.1),
                textMayChange=0, pos=(0.0, 0.0, -0.55),
    ...
    def enterUnpaidChatWarning(self):
        ...
        if self.unpaidChatWarning is None:
            ...
            self.unpaidChatWarning = DirectFrame(
                parent=aspect2dp, pos=(0.0, 0.1, 0.4),
                relief=None, image=DGG.getDefaultDialogGeom(),
                image_color=OTPGlobals.GlobalDialogColor,
            ...
            self.payButton = DirectButton(
                self.unpaidChatWarning, image=buttonImage, relief=None,
            ...
            DirectButton(
                self.unpaidChatWarning, image=buttonImage, relief=None,
                text=directButtonText, textMayChange=0,
    ...
    def enterNoSecretChatAtAll(self):
        if self.noSecretChatAtAll is None:
            ...
            self.noSecretChatAtAll = DirectFrame(
                ...
                text=OTPLocalizer.NoSecretChatAtAll, text_wordwrap=20,
                textMayChange=0, text_scale=0.06, text_pos=(0, 0.3))
            DirectLabel(
                ...
                text_scale=0.08)
            DirectButton(
                self.noSecretChatAtAll, image=okButtonImage, relief=None,
                text=OTPLocalizer.NoSecretChatAtAllOK, text_scale=0.05,
                text_pos=(0.0, -0.1),
                textMayChange=0, pos=(0.0, 0.0, -0.4),
    ...
    def enterNoSecretChatWarning(self, passwordOnly=0):
        ...
        if self.noSecretChatWarning is None:
            ...
            self.noSecretChatWarning = DirectFrame(
                ...
                text=warningText, text_wordwrap=20, text_scale=0.055,
                text_pos=textPos, textMayChange=1)
            DirectButton(
                self.noSecretChatWarning, image=okButtonImage, relief=None,
                text=OTPLocalizer.NoSecretChatWarningOK, text_scale=0.05,
                text_pos=(0.0, -0.1),
            ...
            if base.cr.productName != 'Terra-DMC':
                self.passwordLabel = DirectLabel(
                    parent=self.noSecretChatWarning, relief=None,
                    pos=(-0.07, 0.0, -0.2),
                ...
                self.passwordEntry = DirectEntry(
                    ...
                    scale=0.064, pos=(0.0, 0.0, -0.2),
                    width=OTPGlobals.maxLoginWidth, numLines=1, focus=1,
                    cursorKeys=1, obscured=1,
                    command=self.__handleNoSecretChatWarningOK)
                DirectButton(
                    self.noSecretChatWarning, image=cancelButtonImage,
                    relief=None, text=OTPLocalizer.NoSecretChatWarningCancel,
    ...
    def enterActivateChat(self):
        if self.activateChatGui is None:
            ...
            if base.cr.productName != 'JP':
                DirectButton(
                    self.activateChatGui, image=moreButtonImage,
                    image_scale=(1.25, 1.0, 1.0),
                    relief=None, text=OTPLocalizer.ActivateChatMoreInfo,
                    text_scale=0.06, text_pos=(0, -0.02),
                    textMayChange=0, pos=(0.0, 0.0, -0.7),
                    command=self.__handleActivateChatMoreInfo)
            self.dcb1 = HackedDirectRadioButton(
                parent=self.activateChatGui, relief=None, scale=0.1,
                boxImage=innerCircle, boxImageScale=2.5,
                boxImageColor=VBase4(0, 0.25, 0.5, 1),
                boxRelief=None, pos=(-0.745, 0, 0.297),
                command=self.__updateCheckBoxen, extraArgs=[1])
            self.dcb2 = HackedDirectRadioButton(
                parent=self.activateChatGui, relief=None, scale=0.1,
                boxImage=innerCircle, boxImageScale=2.5,
                boxImageColor=VBase4(0, 0.25, 0.5, 1),
                boxRelief=None, pos=(-0.745, 0, 0.147),
                command=self.__updateCheckBoxen, extraArgs=[2])
            self.dcb3 = HackedDirectRadioButton(
                parent=self.activateChatGui, relief=None, scale=0.1,
                boxImage=innerCircle, boxImageScale=2.5,
                boxImageColor=VBase4(0, 0.25, 0.5, 1),
                boxRelief=None, pos=(-0.745, 0, -0.003),
                command=self.__updateCheckBoxen, extraArgs=[3])
            DirectButton(self.activateChatGui, image=okButtonImage,
                         relief=None, text=OTPLocalizer.ActivateChatYes,
                         text_scale=0.05, text_pos=(0.0, -0.1),
                         textMayChange=0, pos=(-0.35, 0.0, -0.27),
                         command=self.__handleActivateChatYes)
            DirectButton(
                self.activateChatGui, image=cancelButtonImage, relief=None,
                text=OTPLocalizer.ActivateChatNo, text_scale=0.05,
                text_pos=(0.0, -0.1),
                textMayChange=0, pos=(0.35, 0.0, -0.27),
    ...
    def enterSecretChatActivated(self, mode=2):
        ...
        if self.secretChatActivated is None:
            ...
            self.secretChatActivated = DirectFrame(
                ...
                text=modeText, text_align=TextNode.ACenter, text_wordwrap=14,
                text_scale=TTLocalizer.TCMsecretChatActivated,
                text_pos=(0, 0.25))
            DirectButton(
                self.secretChatActivated, image=buttonImage, relief=None,
                text=OTPLocalizer.SecretChatActivatedOK, text_scale=0.05,
                text_pos=(0.0, -0.1),
                textMayChange=0, pos=(0.0, 0.0, -0.1),
    ...
    def enterProblemActivatingChat(self):
        if self.problemActivatingChat is None:
            ...
            self.problemActivatingChat = DirectFrame(
                ...
                text='', text_align=TextNode.ALeft, text_wordwrap=18,
                text_scale=0.06, text_pos=(-0.5, 0.28),
                textMayChange=1)
            DirectButton(
                self.problemActivatingChat, image=buttonImage, relief=None,
                text=OTPLocalizer.ProblemActivatingChatOK, text_scale=0.05,
                text_pos=(0.0, -0.1),
                textMayChange=0, pos=(0.0, 0.0, -0.28),
    ...
    def enterNoSecretChatAtAllAndNoWhitelist(self):
        if self.noSecretChatAtAllAndNoWhitelist is None:
            ...
            self.noSecretChatAtAllAndNoWhitelist = DirectFrame(
                parent=aspect2dp, pos=(0.0, 0.1, 0.05),
                relief=None, image=DGG.getDefaultDialogGeom(),
                image_color=OTPGlobals.GlobalDialogColor,
            ...
            DirectButton(self.noSecretChatAtAllAndNoWhitelist,
                         image=okButtonImage, relief=None,
                         text=OTPLocalizer.NoSecretChatAtAllOK,
                         text_scale=0.05, text_pos=(0.0, -0.1),
                         textMayChange=0, pos=(0.0, 0.0, -0.64),
                         command=self.__handleNoSecretChatAtAllOK)
            buttons.removeNode()
