...
Shirts = [
    ...
    # 150 - Sora, Unused
    'phase_4/maps/tt_t_chr_avt_shirt_buddy.jpg',
    # 151 - Buddy
...
Sleeves = ['phase_3/maps/desat_sleeve_1.jpg',
           ...
           # 137 - Sora, Unused
           'phase_4/maps/tt_t_chr_avt_shirtSleeve_buddy.jpg',
           # 138 - Buddy
    ...
    for tailors in TailorCollections:
        for girlBottoms in TailorCollections[tailors][GIRL_BOTTOMS]:
            if girlBottoms not in TailorCollections[MAKE_A_TOON][GIRL_BOTTOMS]:
                TailorCollections[MAKE_A_TOON][
                    GIRL_BOTTOMS].append(girlBottoms)
        ...
        round(
            x[0], 3), round(
                x[1], 3), round(
                    x[2], 3), round(
                        x[3], 3)), allColorsList)
allowedColors = set(map(lambda x: allColorsListApproximations[x], set(
    [0] + defaultBoyColorList + defaultGirlColorList + [26])))
HatModels = [
    None,
