...
class DistributedPolarBearMgr(DistributedObject.DistributedObject):
    ...
    def announceGenerate(self):
        ...
        self.acceptOnce(
            DistributedPolarBearMgr.ActivateEvent,
            self.d_requestPolarBearTransformation)
    ...
    def doPolarBearTransformation(self, avId):
        ...
        if not toon:
            DistributedPolarBearMgr.notify.warning(
                "couldn't find Toon %s" % avId)
            return
