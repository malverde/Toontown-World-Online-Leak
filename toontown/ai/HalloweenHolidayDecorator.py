...
class HalloweenHolidayDecorator(HolidayDecorator.HolidayDecorator):
    ...
    def __checkStreetValidity(self):
        if hasaTTW(base.cr.playGame, 'getPlace') and base.cr.playGame.getPlace() and isinstance(base.cr.playGame.getPlace(), Street.Street) and hasaTTW(base.cr.playGame.getPlace(), 'loader') and base.cr.playGame.getPlace().loader and hasaTTW(base.cr.playGame.getPlace().loader, 'geom') and base.cr.playGame.getPlace().loader.geom:
            return True
        else:
            if hasaTTW(base.cr.playGame, 'getPlace') and base.cr.playGame.getPlace():
    ...
    def __checkHoodValidity(self):
        if (hasaTTW(base.cr.playGame, 'getPlace') and
            ...
            hasaTTW(base.cr.playGame.getPlace(), 'loader') and
            base.cr.playGame.getPlace().loader and
            hasaTTW(base.cr.playGame.getPlace().loader, 'hood') and
            base.cr.playGame.getPlace().loader.hood and
            hasaTTW(base.cr.playGame.getPlace().loader.hood, 'loader') and
            base.cr.playGame.getPlace().loader.hood.loader and
            hasaTTW(base.cr.playGame.getPlace().loader.hood.loader, 'geom') and
    ...
    def __startSpookySky(self):
        if (self.__checkHoodValidity() or self.__checkStreetValidity()) and hasaTTW(base.cr.playGame.hood, 'sky') and base.cr.playGame.hood.sky:
    ...
    def decorate(self):
        ...
        if ToontownGlobals.HALLOWEEN_COSTUMES not in holidayIds and ToontownGlobals.SPOOKY_COSTUMES not in holidayIds:
            return
        if (self.__checkHoodValidity() or self.__checkStreetValidity()) and hasaTTW(base.cr.playGame, 'hood') and base.cr.playGame.hood and hasaTTW(base.cr.playGame.hood, 'sky') and base.cr.playGame.hood.sky:
