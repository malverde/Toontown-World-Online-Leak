    ...
    featherTrack = Parallel(
        ...
        Sequence(
            ...
            MovieUtil.getScaleIntervals(
                feathers, dFeatherScaleUp, MovieUtil.PNT3_NEARZERO,
                feathers[0].getScale)),
        Sequence(
...
def __healSmooch(heal, hasInteractivePropHealBonus):
    ...
    lipstickTrack = Sequence(
        ...
        MovieUtil.getScaleIntervals(
            lipsticks, dScale, MovieUtil.PNT3_NEARZERO,
            MovieUtil.PNT3_ONE),
        Wait(toon.getDuration('smooch') - 2.0 * dScale),
        MovieUtil.getScaleIntervals(
            lipsticks, dScale, MovieUtil.PNT3_ONE,
            MovieUtil.PNT3_NEARZERO),
...
def __healDance(heal, hasInteractivePropHealBonus):
    ...
    propTrack = Sequence(
        Func(
            ...
            Point3(180, 0, 0)),
        Func(
            MovieUtil.showProps, canes, leftHands,
            Point3(-0.28, 0.0, 0.14),
            Point3(0.0, 0.0, -150.0)),
        MovieUtil.getScaleIntervals(
            hats + canes, dScale, MovieUtil.PNT3_NEARZERO,
            MovieUtil.PNT3_ONE),
        Wait(toon.getDuration('happy-dance') - 2.0 * dScale),
        MovieUtil.getScaleIntervals(
            hats + canes, dScale, MovieUtil.PNT3_ONE,
            MovieUtil.PNT3_NEARZERO),
