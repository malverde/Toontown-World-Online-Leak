...
class RewardPanel(DirectFrame):
    ...
    def __init__(self, name):
        ...
        self.avNameLabel = DirectLabel(
            parent=self, relief=None, pos=(
                0, 0, 0.3), text=name, text_scale=0.08)
        ...
        self.itemLabel = DirectLabel(
            parent=self.itemFrame, text='', text_scale=0.06)
        ...
        for i in range(ToontownGlobals.MaxQuestCarryLimit):
            label = DirectLabel(
                parent=self.questFrame, relief=None, pos=(-0.85, 0, -0.1 * i),
        ...
        self.newGagFrame = DirectFrame(
            parent=self, relief=None, pos=(
                0, 0, 0.24), text='', text_wordwrap=14.4, text_pos=(
        ...
        self.congratsLeft = DirectLabel(
            parent=self.newGagFrame, pos=(-0.2, 0, -0.1),
            text='', text_pos=(0, 0),
            text_scale=0.06)
        self.congratsLeft.setHpr(0, 0, -30)
        self.congratsRight = DirectLabel(parent=self.newGagFrame, pos=(
            0.2, 0, -0.1), text='', text_pos=(0, 0), text_scale=0.06)
        ...
        for i in range(len(SuitDNA.suitDepts)):
            deptName = TextEncoder.upper(
                SuitDNA.suitDeptFullnames[
                    SuitDNA.suitDepts[i]])
            self.meritLabels.append(
                DirectLabel(
                    parent=self.gagExpFrame, relief=None, text=deptName,
        ...
        for i in range(len(ToontownBattleGlobals.Tracks)):
            ...
            self.trackLabels.append(
                DirectLabel(
                    parent=self.gagExpFrame, relief=None,
                    text=trackName,
            ...
            self.trackBars.append(
                DirectWaitBar(
                    ...
                    barColor=(ToontownBattleGlobals.TrackColors[i][0],
                              ...
                              1),
                    text='0/0', text_scale=0.18, text_fg=(0, 0, 0, 1),
            ...
            if CogDisguiseGlobals.isSuitComplete(toon.cogParts, i):
                ...
                if totalMerits:
                    ...
                    if promoStatus != ToontownGlobals.PendingPromotion:
                        meritBar[
                            'text'] = '%s/%s %s' % (merits, totalMerits, TTLocalizer.RewardPanelMeritBarLabels[i])
    ...
    def getTrackIntervalList(
        ...
        uberSkill = ToontownBattleGlobals.UberSkill + ToontownBattleGlobals.Levels[
            track][ToontownBattleGlobals.LAST_REGULAR_GAG_LEVEL + 1]
        if currentSkill >= uberSkill and not hasUber > 0:
            ...
            intervalList.append(Wait(0.1))
            skillDiff = currentSkill - ToontownBattleGlobals.Levels[
                track][ToontownBattleGlobals.LAST_REGULAR_GAG_LEVEL + 1]
    ...
    def promotion(self, toon, dept):
        ...
        self.promotionFrame[
            'text'] = TTLocalizer.RewardPanelPromotion % SuitDNA.suitDeptFullnames[name]
