...
class FireCogPanel(StateData.StateData):
    ...
    def load(self):
        ...
        self.frame = DirectFrame(
            relief=None, image=gui.find('**/BtlPick_TAB'),
            image_color=Vec4(1, 0.2, 0.2, 1))
        self.frame.hide()
        self.statusFrame = DirectFrame(
            parent=self.frame, relief=None, image=gui.find(
                '**/ToonBtl_Status_BG'),
        ...
        for i in range(4):
            button = DirectButton(
                ...
                text_scale=0.067, text_pos=(0, -0.015, 0),
                textMayChange=1, image_scale=(1.0, 1.0, 1.0),
        ...
        self.backButton = DirectButton(
            ...
            pos=(-0.647, 0, 0.006),
            scale=1.05, text=TTLocalizer.TownBattleChooseAvatarBack,
            text_scale=0.05, text_pos=(0.01, -0.012),
