...
class DistributedToonHallInterior(DistributedToonInterior):
    ...
    def __init__(self, cr):
        ...
        self.sillyFSM = ClassicFSM.ClassicFSM(
            'SillyOMeter',
            [State.State(
                'Setup', self.enterSetup, self.exitSetup,
             ...
             State.State(
                 ...
                 ['Phase5', 'Flat', 'Off']),
             State.State(
                 'Phase5', self.enterPhase5, self.exitPhase5,
                 ['Phase6', 'Flat', 'Off']),
             State.State(
                 'Phase6', self.enterPhase6, self.exitPhase6,
                 ['Phase7', 'Flat', 'Off']),
             State.State(
                 'Phase7', self.enterPhase7, self.exitPhase7,
                 ['Phase8', 'Flat', 'Off']),
             State.State(
                 'Phase8', self.enterPhase8, self.exitPhase8,
                 ['Phase9', 'Flat', 'Off']),
             State.State(
                 'Phase9', self.enterPhase9, self.exitPhase9,
                 ['Phase10', 'Flat', 'Off']),
             State.State(
                 'Phase10', self.enterPhase10, self.exitPhase10,
                 ['Phase11', 'Flat', 'Off']),
             State.State(
                 'Phase11', self.enterPhase11, self.exitPhase11,
                 ['Phase12', 'Flat', 'Off']),
             State.State(
                 'Phase12', self.enterPhase12, self.exitPhase12,
                 ['Phase13', 'Flat', 'Off']),
             State.State(
                 'Phase13', self.enterPhase13, self.exitPhase13,
                 ['Phase14', 'Flat', 'Off']),
             State.State(
                 'Phase14', self.enterPhase14, self.exitPhase14,
                 ['Phase15', 'Flat', 'Off']),
             State.State(
                 'Phase15', self.enterPhase15, self.exitPhase15,
                 ['Flat', 'Off']),
             State.State(
                 'Flat', self.enterFlat, self.exitFlat, ['Off', 'Phase0']),
    ...
    def selectPhase(self, newPhase):
        try:
            ...
            if self.sillyFSM.hasStateNamed(gotoPhase) and not self.sillyFSM.getCurrentState(
    ...
    def enterPhase1(self):
        ...
        self.animSeq = Sequence(
            Sequence(
                ActorInterval(
                    self.sillyMeter, 'arrowTube',
                    partName='arrow', constrainedLoop=0,
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=42,
                    endFrame=71),
                Sequence(
                    Func(self.phase1Sfx.play),
                    Func(
                        self.audio3d.attachSoundToObject,
                        self.phase1Sfx, self.sillyMeter))))
        self.animSeq.start()
        self.sillyMeter.loop('phaseOne', partName='meter')
        self.accept('SillyMeterPhase', self.selectPhase)
        ...
        self.animSeq = Sequence(
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=83,
                    endFrame=112),
                Sequence(
                    Func(self.phase1Sfx.play),
                    Func(
        ...
        self.animSeq = Sequence(
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=124,
                    endFrame=153),
                Sequence(
                    Func(self.phase1Sfx.play),
                    Func(
        ...
        self.animSeq = Sequence(
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=165,
                    endFrame=194),
                Sequence(
                    Func(self.phase2Sfx.play),
                    Func(
                        self.audio3d.attachSoundToObject,
                        self.phase2Sfx, self.sillyMeter))))
        self.animSeq.start()
        self.smPhase2.show()
        ...
        self.animSeq = Sequence(
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=206,
                    endFrame=235),
                Sequence(
                    Func(self.phase2Sfx.play),
                    Func(
        ...
        self.animSeq = Sequence(
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=247,
                    endFrame=276),
                Sequence(
                    Func(self.phase3Sfx.play),
                    Func(
                        self.audio3d.attachSoundToObject,
                        self.phase3Sfx, self.sillyMeter))))
        self.animSeq.start()
        self.smPhase2.show()
        self.smPhase3.show()
        ...
        self.animSeq = Sequence(
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=288,
                    endFrame=317),
                Sequence(
                    Func(self.phase3Sfx.play),
                    Func(
        ...
        self.animSeq = Sequence(
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=329,
                    endFrame=358),
                Sequence(
                    Func(self.phase3Sfx.play),
                    Func(
        ...
        self.animSeq = Sequence(
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=370,
                    endFrame=399),
                Sequence(
                    Func(self.phase4Sfx.play),
                    Func(
                        self.audio3d.attachSoundToObject,
                        self.phase4Sfx, self.sillyMeter))))
        self.animSeq.start()
        self.smPhase2.show()
        self.smPhase3.show()
        self.smPhase4.show()
        ...
        self.animSeq = Sequence(
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=411,
                    endFrame=440),
                Sequence(
                    Func(self.phase4Sfx.play),
                    Func(
        ...
        self.animSeq = Sequence(
            ...
            Parallel(
                ActorInterval(
                    ...
                    partName='arrow',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=452,
                    endFrame=481),
                Sequence(
                    Func(self.phase4Sfx.play),
                    Func(
    ...
    def enterPhase13(self):
        ...
        self.animSeq = Sequence(
            Parallel(
                ...
                ActorInterval(
                    self.sillyMeter, 'phaseFourToFive',
                    constrainedLoop=0, startFrame=1,
                    endFrame=120)),
            Parallel(
                ActorInterval(
                    self.sillyMeter, 'phaseFive',
                    duration=phaseDuration,
                    constrainedLoop=1, startFrame=1,
                    endFrame=48),
                Sequence(
                    Func(self.phase5Sfx.play),
                    Func(
                        self.audio3d.attachSoundToObject,
                        self.phase5Sfx, self.sillyMeter))))
        self.animSeq.start()
        self.smPhase2.show()
        self.smPhase3.show()
        self.smPhase4.show()
