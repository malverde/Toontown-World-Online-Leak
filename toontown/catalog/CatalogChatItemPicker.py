...
class CatalogChatItemPicker(DirectObject.DirectObject):
    ...
    def __init__(self, callback, newMsg):
        ...
        self.picker = DirectScrolledList(
            parent=self.panel, relief=None, pos=(0, 0, 0),
        ...
        exitButton = DirectButton(
            ...
            text_scale=TTLocalizer.CCIPexitButton, text_pos=(-0.005, -0.01),
            text_fg=Vec4(1, 1, 1, 1),
            textMayChange=0, image=(upButton, downButton, rolloverButton),
            image_scale=1.1, image_color=(0, 0.6, 1, 1),
    ...
    def makeMessageButton(self, name, number, *extraArgs):
        ...
        return DirectButton(
            relief=None, text=OTPLocalizer.CustomSCStrings[msg],
            text_pos=(-0.5, 0, 0),
