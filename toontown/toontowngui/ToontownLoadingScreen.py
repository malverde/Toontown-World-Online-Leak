...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        # To save you the trouble, you can get the converted models from here: https://dl.dropboxusercontent.com/u/37515491/TTW/misc.zip - Tell someone if the link is broken.
