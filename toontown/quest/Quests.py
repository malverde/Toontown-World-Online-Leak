...
class Quest:
	...
	def checkCogLevel(self, level):
		self.check(1 <= level <= 12, 'invalid cog level: %s' % level)
	...
	def checkBuildingFloors(self, floors):
		self.check(1 <= floors <= 5, 'invalid num floors: %s' % floors)
	...
	def checkGagTrack(self, track):
		self.check(ToontownBattleGlobals.MIN_TRACK_INDEX <= track <= ToontownBattleGlobals.MAX_TRACK_INDEX, 'invalid gag track: %s' % track)

	def checkGagItem(self, item):
		self.check(ToontownBattleGlobals.MIN_LEVEL_INDEX <= item <= ToontownBattleGlobals.MAX_LEVEL_INDEX, 'invalid gag item: %s' % item)
	...
	def checkPercentChance(self, chance):
		self.check(0 < chance <= 100, 'invalid percent chance: %s' % chance)
	...
	def checkTrackChoice(self, option):
		self.check(ToontownBattleGlobals.MIN_TRACK_INDEX <= option <= ToontownBattleGlobals.MAX_TRACK_INDEX, 'invalid track option: %s' % option)
...
QuestDict = {
 ...
 145: (TT_TIER,
	   ...
	   150,
	   DefaultDialog),
150: (TT_TIER, Cont, (FriendQuest,), Same, Same, NA, 1039, DefaultDialog),
1039:(TT_TIER, Cont, (VisitQuest,), Any, 2135, NA, (1041, 1042, 1043), TTLocalizer.QuestDialogDict[1039]),
1040:(TT_TIER, Cont, (VisitQuest,), Any, 2207, NA, (1041, 1042, 1043), TTLocalizer.QuestDialogDict[1040]),
1041:(TT_TIER, Cont, (VisitQuest,), Same, 2211, NA, 1044, TTLocalizer.QuestDialogDict[1041]),
1042:(TT_TIER, Cont, (VisitQuest,), Same, 2209, NA, 1044, TTLocalizer.QuestDialogDict[1042]),
1043:(TT_TIER, Cont, (VisitQuest,), Same, 2210, NA, 1044, TTLocalizer.QuestDialogDict[1043]),
 160: (TT_TIER,
	   OBSOLETE,
	   (CogTrackQuest,
		ToontownGlobals.ToontownCentral,
 ...
 6324: (DL_TIER,
		Start,
		(MintQuest, ToontownGlobals.CashbotMintIntA, 2),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 7262: (DL_TIER + 1,
		Start,
		(SkelecogQuest, ToontownGlobals.CashbotHQ, 15),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 8210: (DL_TIER + 2,
		Start,
		(MintQuest, ToontownGlobals.CashbotMintIntA, 7),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 8211: (DL_TIER + 2,
		Start,
		(MintQuest, ToontownGlobals.CashbotMintIntB, 5),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 8212: (DL_TIER + 2,
		Start,
		(MintQuest, ToontownGlobals.CashbotMintIntC, 4),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 8216: (DL_TIER + 2,
		Start,
		(SupervisorQuest, ToontownGlobals.CashbotMintIntA, 7),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 8217: (DL_TIER + 2,
		Start,
		(SupervisorQuest, ToontownGlobals.CashbotMintIntB, 5),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 8218: (DL_TIER + 2,
		Start,
		(SupervisorQuest, ToontownGlobals.CashbotMintIntC, 4),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 9150: (DL_TIER + 3,
		...
		NA,
		DefaultDialog),
		#damn this is too big change it to smaller i do , used to be 400 :O
 9151: (DL_TIER + 3,
		Start,
		(BuildingQuest,
		 Anywhere,
 ...
 9179: (DL_TIER + 3,
		OBSOLETE,
		(FactoryQuest, ToontownGlobals.SellbotHQ, 15),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 9180: (DL_TIER + 3,
		OBSOLETE,
		(FactoryQuest, ToontownGlobals.SellbotHQ, 18),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 9183: (DL_TIER + 3,
		OBSOLETE,
		(SkelecogQuest, ToontownGlobals.SellbotFactoryInt, 100),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 9186: (DL_TIER + 3,
		OBSOLETE,
		(ForemanQuest, ToontownGlobals.SellbotHQ, 15),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 9187: (DL_TIER + 3,
		OBSOLETE,
		(ForemanQuest, ToontownGlobals.SellbotHQ, 18),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 9210: (DL_TIER + 3,
		Start,
		(MintQuest, ToontownGlobals.CashbotMintIntA, 10),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 9211: (DL_TIER + 3,
		Start,
		(MintQuest, ToontownGlobals.CashbotMintIntB, 8),
		Any,
		ToonHQ,
		Any,
		NA,
 ...
 10141: (ELDER_TIER,
		 Start,
		 (MintQuest, ToontownGlobals.CashbotHQ, 3),
		 Any,
		 ToonHQ,
		 Any,
		 NA,
 ...
 10142: (ELDER_TIER,
		 Start,
		 (SupervisorQuest, ToontownGlobals.CashbotHQ, 3),
		 Any,
		 ToonHQ,
		 Any,
		 NA,
