...
parser.add_argument('--launcher-version', default='',
...
parser.add_argument('--client-agent', default='108.161.134.133',
...
parser.add_argument('--resources-revision', default='resources',
