...
!define APP_NAME "Toontown Rewritten"
!define COMP_NAME "The TTR Team"
!define WEB_SITE "https://www.toontownrewritten.com"
!define VERSION "00.00.00.00"
!define COPYRIGHT ""
!define DESCRIPTION "Toontown Rewritten"
!define INSTALLER_NAME "TTRInstaller.exe"
...
InstallDir "$PROGRAMFILES\Toontown Rewritten"
...
!define MUI_WELCOMEPAGE_TEXT "This setup will prepare your computer to run Toontown Rewritten Beta. If you still have Toontown Rewritten Alpha installed, this setup will upgrade your Alpha installation into a Beta installation. If you have Toontown Rewritten Beta installed, this setup will upgrade your launcher to the current version."
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Toontown Rewritten"
...
!define MUI_WELCOMEPAGE_TEXT "Setup will guide you through the uninstallation of $(^NameDA). This uninstallation process will not delete any Toontown Rewritten log files, screenshots, or settings."
...
Delete "$INSTDIR\TTRLauncher.exe"
...
CreateDirectory "$SMPROGRAMS\Toontown Rewritten"
CreateShortCut "$SMPROGRAMS\Toontown Rewritten\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} Official Site.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\Toontown Rewritten\${APP_NAME} Official Site.lnk" "$INSTDIR\${APP_NAME} Official Site.url"
!endif
!endif
...
Delete "$INSTDIR\TTREngine.exe"
Delete "$INSTDIR\TTRGame.bin"
...
!ifndef REG_START_MENU
Delete "$SMPROGRAMS\Toontown Rewritten\${APP_NAME}.lnk"
!ifdef WEB_SITE
Delete "$SMPROGRAMS\Toontown Rewritten\${APP_NAME} Official Site.lnk"
!endif
Delete "$DESKTOP\${APP_NAME}.lnk"

RmDir "$SMPROGRAMS\Toontown Rewritten"
!endif
